    ...
    <div class="container">
        <div class="row">
            ...
            <div class="items">
                    ...
                    <input type="text" id ="Search" name="Search" style="width: 250px; padding: 8px; margin: 3px 0 11px 0; display: inline-block; font-size:12pt;"> 
                    <button class="common_selector button" name="searchBtn" type="submit">Search</button>
