    ...
    if(isset($_POST["action"]))
    {
        ...
        { 
            foreach($result as $row)
            {
                ...
                $output .= '
                <div class="list">
                    <div style="border:1px solid #ccc; border-radius:5px; padding:16px; margin-bottom:16px; height:580px;">
                        <div class="group">
                            ...
                            <p>Quantity: <b>'.$row['Quantity'].'</b><hr>
                            Publisher Name: <br><br><b>'. $data .' </b><hr></p>
                        <div class="desc">
                            <p>Description: <br><br><b>'.$row['Description'].'</b></p>
                        </div>
                        <div class= "cartbutton">
                                <a class="addtocart" style="font-weight: 900;" href="mdetail.php?id='.$row['Game_ID'].'">View Details</a>
                        </div>
                        <br>
                        <br>
                        <div class= "cartbutton">
                            <a class="addtocart" style="font-weight: 900;" href="addcart.php?id='.$row['Game_ID'].'">Add to Cart</b></a>
                        </div>
                    </div>
