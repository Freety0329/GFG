...
<form method="post">
	<input type="text" style="width: 500px; padding: 8px; margin: 5px 0 11px 0; display: inline-block; font-size:12pt;" name="search_key"> <button class="button1" name="searchBtn" type="submit">Search</button>
</form>
</div>
